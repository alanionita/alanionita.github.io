...
No one knows what an unconference is before they go to an unconfence. Even as I'm writing this the spell-checker is confused: "Do you mean conference?"
...
Pete told stories about HAM radio, using radios whilst hiking, and how MeshCore is better than Meshtastic. He rocked his own MeshCore node, but he wasn't alone with a handful of other node cropping up. There was an unconference talk on radios to, and I've already put a MeshCore device on my Christmas present list.
...
A Yocto Project contributor was there too and we spoke hard embedded project bugs, AWS Greengrass, and the Yocto Project itself.
...
The intersection of other attendee interests and my own was very large, to point where I'd have difficulty picking enough single topic conferences that can match.

To get the same results I would have to attend:
...
OggCamp26 was ace because it enabled conversations across all of those topics. If OggCamp26 were an all you can eat buffet it would be one that carries a lot of dishes from around the world with each being the best version of that dish: the best pizza, the best curry, the best ramen, and the best schnitzel.  
